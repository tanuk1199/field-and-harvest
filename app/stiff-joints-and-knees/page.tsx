...
import { JntAsset } from "@/components/jnt-asset"
...
export default function StiffJointsAndKnees() {
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-5 text-center">
          ...
          >
            5 Reasons Men Are Using Field &amp; Harvest Turmeric{" "}
            <span className="text-[#C86F4C]">To Fight Stiff Joints, Knee Pain And Poor Mobility</span>
          </h2>
      ...
      <section className="max-w-lg mx-auto px-4 py-12 space-y-10">
        ...
        <div id="reason-3" className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            It covers the second pathway, the one your pain reliever never reaches
          </h3>
          <p className="text-sm font-bold uppercase tracking-wide text-[#C86F4C] mb-6">
        ...
        <div id="reason-5" className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            ...
            <span className="font-bold text-foreground">
              Take it daily for two months. If the stairs and the first ten minutes of the morning are no different, email us inside ninety days. We refund you and you keep the bottles.
            </span>
          </p>
        </div>
      </section>
            ...
            {WORK_YEAR.map((row) => (
              ...
              >
                <div className="h-14 w-14 shrink-0 overflow-hidden rounded-md bg-muted">
                  <JntAsset name={row.photo} alt={row.alt} className="h-full w-full" />
                </div>
