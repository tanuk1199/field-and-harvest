...
// Layout-test arm B. This page is served BY REWRITE at /the-trimmer-switch for half of
// visitors, so every piece of metadata here must match the arm A layout exactly, including
// the OG url. Canonical points at /the-trimmer-switch so search engines consolidate on the
// real URL instead of treating this as a duplicate page. Deliberately NOT noindex: this
// metadata is what half of real /the-trimmer-switch traffic receives, and a noindex here
// would risk deindexing the live URL.
