...
import { FdAsset } from "@/components/fd-asset"
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <p className="text-[11px] sm:text-xs md:text-sm font-bold tracking-wide text-white uppercase leading-snug">
          ...
          Father&apos;s Day Special — Order by June 16th for Guaranteed Delivery
      ...
      <header className="py-3 px-4 flex items-center justify-center bg-card">
        <FdAsset name="logo" alt="Field & Harvest Co." className="h-7 md:h-10 w-auto object-contain" fallbackClassName="text-2xl md:text-3xl font-bold text-primary tracking-tight" />
      </header>
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-lg bg-muted">
          <FdAsset name="heroImage" alt="The Grange Carrier" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
        </div>
        ...
        <div className="mt-5 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground leading-tight text-balance tracking-tight">
            6 Reasons This Is the <span className="text-[#C86F4C]">Father&apos;s Day Gift</span> He&apos;ll Actually Use Every Week
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mt-4 leading-relaxed text-pretty max-w-md mx-auto">
            Skip the tie and the grilling tools. If your dad, grandpa, or the man in your life spends his mornings in the garden, this is the gift he&apos;ll reach for every single time he walks outside.
          </p>
        </div>
        ...
        <a href={PDP_URL}>
          ...
          >
            Get the Perfect Gift for Him &rarr;
          </Button>
        </a>
      ...
      <section className="max-w-lg mx-auto px-4 py-12 space-y-10">
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            He&apos;ll never bend over the sink scooping produce again
          </h3>
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason1Image" alt="Quick-Release Drop-Chute" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Most carriers make you reach in and scoop everything out by hand. The Grange Carrier has industrial-grade buckles on the bottom that unlatch with a pinch. His entire harvest slides out in one motion. <span className="font-bold text-foreground">Gardeners report saving 15-20 minutes per session.</span> That&apos;s time he gets back every single day.
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            No more sore back and shoulders after a morning in the garden
          </h3>
          <p className="text-sm font-bold uppercase tracking-wide text-[#C86F4C] mb-6">
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason2Image" alt="Zero-Gravity Cross-Back Harness" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            If he&apos;s been hauling a bucket or wearing a loop-style apron, the full load pulls on his lower back. An hour in and his body quits before his garden does. The cross-back harness distributes weight across both shoulders and his back like a hiking pack. <span className="font-bold text-foreground">Gardeners in their 60s and 70s say this is what lets them keep gardening pain-free.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            A gift he won&apos;t need to replace next year (or ever)
          </h3>
          <p className="text-sm font-bold uppercase tracking-wide text-[#C86F4C] mb-6">
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason3Image" alt="Field-Weave 600D Canvas" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Cheap aprons fray, sag, and tear within a season or two. Field-Weave 600D Canvas is the same material found in expedition-grade hiking packs. Thorn-proof, puncture-resistant, and light enough to forget it&apos;s there. <span className="font-bold text-foreground">This is the kind of gift that gets better with age. He&apos;ll still be using it years from now.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            Both hands free, everything he needs in one trip
          </h3>
          <p className="text-sm font-bold uppercase tracking-wide text-[#C86F4C] mb-6">
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason4Image" alt="20-pound kangaroo pouch" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            No more juggling a bucket in one hand and shears in the other. The kangaroo-style pouch holds a full 20 pounds without collapsing, and built-in tool sheaths and a zippered phone pocket mean he carries everything at once. <span className="font-bold text-foreground">One trip. Hands free. Nothing left behind.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-2 text-balance leading-tight">
            Wipes clean, dries fast, and is back in the rotation tomorrow morning
          </h3>
          <p className="text-sm font-bold uppercase tracking-wide text-[#C86F4C] mb-6">
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason5Image" alt="Dry-Wear water-resistant barrier" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Cotton aprons soak through in minutes. Dew, tomato juice, wet soil, it all transfers straight to his clothes. The Dry-Wear barrier lines the entire pouch and stops moisture from reaching his shirt. <span className="font-bold text-foreground">Hose it down, hang it up, and it&apos;s ready to go again at sunrise.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-6 shadow-md">
            <FdAsset name="reason6Image" alt="Lifetime warranty guarantee" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
          </div>

          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Lifetime warranty against defects in materials and craftsmanship. If the fabric, stitching, or buckles fail, we replace it. And if he&apos;s not sure? He has 60 days to try it. Full refund, we cover return shipping. <span className="font-bold text-foreground">You&apos;re not risking anything. You&apos;re giving him the last carrier he&apos;ll ever need.</span>
          </p>
        </div>
      </section>
      ...
      <section className="max-w-lg mx-auto px-4 pt-12 pb-4">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-6 text-pretty leading-relaxed max-w-md mx-auto">
            One carrier. Two free gardening guides. A lifetime warranty. This Father&apos;s Day, give him something he&apos;ll actually reach for every morning.
          </p>
        ...
        <div className="bg-card border-2 border-border rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="p-5">
            ...
            <div className="relative w-full aspect-square rounded-lg overflow-hidden bg-muted mb-4">
              <FdAsset name="productMain" alt="The Grange Carrier" className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-4xl" />
            </div>
            ...
            <div className="grid grid-cols-6 gap-1.5 mb-5">
              {(["productThumb1", "productThumb2", "productThumb3", "productThumb4", "productThumb5", "productThumb6"] as const).map((name, i) => (
                <div key={i} className="relative aspect-square rounded-md border-2 border-border bg-muted hover:border-primary transition-colors cursor-pointer overflow-hidden">
                  <FdAsset name={name} alt={`Product view ${i + 1}`} className="w-full h-full object-cover" fallbackClassName="w-full h-full flex items-center justify-center text-[10px] text-muted-foreground font-bold" />
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-5">
              <div className="bg-[#F4EFE3] rounded-lg p-3.5 flex items-start gap-2.5">
                <div className="w-5 h-5 flex-shrink-0 mt-0.5">
                  <FdAsset name="benefitIcon1" alt="Lightning" className="w-5 h-5 object-contain" fallbackClassName="text-base" />
                </div>
                <p className="text-xs text-foreground font-semibold leading-snug">1-Second Drop-Chute empties your harvest instantly</p>
              </div>
              <div className="bg-[#F4EFE3] rounded-lg p-3.5 flex items-start gap-2.5">
                <div className="w-5 h-5 flex-shrink-0 mt-0.5">
                  <FdAsset name="benefitIcon2" alt="Feather" className="w-5 h-5 object-contain" fallbackClassName="text-base" />
                </div>
                <p className="text-xs text-foreground font-semibold leading-snug">Zero-Gravity Harness carries 20 lbs pain-free</p>
              </div>
              <div className="bg-[#F4EFE3] rounded-lg p-3.5 flex items-start gap-2.5">
                <div className="w-5 h-5 flex-shrink-0 mt-0.5">
                  <FdAsset name="benefitIcon3" alt="Shield" className="w-5 h-5 object-contain" fallbackClassName="text-base" />
                </div>
                <p className="text-xs text-foreground font-semibold leading-snug">600D Canvas, thorn-proof and built for decades</p>
              </div>
              <div className="bg-[#F4EFE3] rounded-lg p-3.5 flex items-start gap-2.5">
                <div className="w-5 h-5 flex-shrink-0 mt-0.5">
                  <FdAsset name="benefitIcon4" alt="Water drop" className="w-5 h-5 object-contain" fallbackClassName="text-base" />
                </div>
      ...
      <section className="max-w-lg mx-auto px-4 py-12">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-lg p-5">
            ...
            <p className="text-sm font-bold text-foreground mb-2">&ldquo;My son got me this for Father&apos;s Day. Best gift in years.&rdquo;</p>
            <p className="text-sm text-foreground/75 leading-relaxed mb-3">
              I&apos;ve been gardening for 30 years and have gone through more buckets and aprons than I can count. This is the first one that actually feels like it was designed by someone who gardens. The drop chute alone is worth it. I use it every single morning.
            </p>
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold text-foreground">Robert T.</span>
          ...
          <div className="bg-card border border-border rounded-lg p-5">
            ...
            <p className="text-sm text-foreground/75 leading-relaxed mb-3">
              He&apos;s 71 and gardens every day. His old setup was a 5-gallon bucket and a beat-up tool belt and his back would be killing him by lunch. He said the cross-back straps changed everything. He carried a full load of tomatoes and didn&apos;t feel it. That phone call alone was worth the price.
            </p>
            <div className="flex items-center gap-2">
          ...
          <div className="bg-card border border-border rounded-lg p-5">
            ...
            <p className="text-sm font-bold text-foreground mb-2">&ldquo;Got one for my husband, then he ordered one for his father.&rdquo;</p>
            <p className="text-sm text-foreground/75 leading-relaxed mb-3">
              He saw it sitting on the bench and asked where it came from. We garden together most weekends and now we both walk through the rows hands-free, fill up, and dump everything at the potting bench in seconds. He liked it so much he sent one to his dad for Father&apos;s Day.
            </p>
            <div className="flex items-center gap-2">
      ...
      <section className="max-w-lg mx-auto px-4 pt-8 pb-32">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-muted-foreground text-pretty max-w-md mx-auto">
            Everything you need to know before you gift the last carrier he&apos;ll ever own.
          </p>
        </div>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          <AccordionItem value="item-3" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              It&apos;s less than another tie or a tool he already owns. And unlike most Father&apos;s Day gifts, this lasts a lifetime. He also gets two gardening guides ($33 value) included for free. It&apos;s a $49 gift that feels like $100+ and actually gets used.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              He has 60 days to try it in his own garden. Full refund, we cover return shipping. No restocking fee, no questions. You&apos;re not risking a thing.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-5" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            <AccordionTrigger className="text-left font-bold text-foreground hover:no-underline py-5">
              Will it fit him? I&apos;m worried about sizing.
            </AccordionTrigger>
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              The Cross-Back Harness adjusts to fit most body types. The straps are designed to distribute weight evenly whether he&apos;s picking herbs or hauling a full 20-pound tomato harvest. Gardeners from their 30s through their 80s use it comfortably.
            </AccordionContent>
          </AccordionItem>
