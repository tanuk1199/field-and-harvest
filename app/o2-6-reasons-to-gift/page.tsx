...
export default function O2GiftListiclePage() {
  return (
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mt-4 leading-relaxed text-pretty max-w-md mx-auto">
            Seeds get forgotten. Gloves wear out by June. The Grange Carrier is the one garden gift 22,000+ people use every single harvest. And right now, for our Early Spring Sale, you can get two for the price of one — one for them, one for you.
          </p>
        </div>
      ...
      <section className="max-w-lg mx-auto px-4 pt-12 pb-4">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance leading-tight">
            Give Two. Pay for One. Spring Won&apos;t Wait.
          </h2>
          <p className="text-lg text-muted-foreground mb-6 text-pretty leading-relaxed max-w-md mx-auto">
            Two carriers. Two sets of free guides. Both backed by a lifetime warranty. Give the gift that keeps giving — and keep one for yourself while you&apos;re at it.
          </p>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="item-1" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              You get two Grange Carriers for the price of one. Give both as gifts, or keep one for yourself and gift the other. Both come with the full lifetime warranty, 60-day guarantee, and two free gardening guides each. It&apos;s our early spring celebration — the best time to stock up on gifts for the gardeners in your life.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-5" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            <AccordionTrigger className="text-left font-bold text-foreground hover:no-underline py-5">
              What exactly is included with each carrier?
            </AccordionTrigger>
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              Each Grange Carrier comes with the Zero-Gravity Cross-Back Harness, Quick-Release Drop-Chute, deep tool sheaths for pruning shears, a hidden waterproof phone pocket, The Endless Harvest gardening guide ($18 value), and the Harvest Keeper&apos;s Handbook for produce storage ($15 value). Plus a lifetime warranty on all materials and craftsmanship.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-6" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              Orders are processed within 1 business day. Standard shipping is 3-5 business days. Both carriers ship together in one package.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
