...
export default function O2GiftThatLastsPage() {
  return (
    <div className="min-h-screen bg-[#F4EFE3]">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-4 md:space-y-6 lg:order-1">
            ...
            <p className="text-base md:text-lg text-[#666666] leading-relaxed text-center lg:text-left">
              Skip the seeds and gloves this year. Give them the harvest carrier 22,000+ gardeners call &ldquo;the last one I&apos;ll ever need.&rdquo; This spring, buy one and get a second free — one for them, one for you.
            </p>
        ...
        <div className="bg-[#3D2E1E] py-3 overflow-hidden">
          <div className="flex items-center gap-8 whitespace-nowrap animate-marquee">
            <div className="flex items-center gap-2 text-white font-semibold">
              ...
              <span className="uppercase tracking-wider">EARLY SPRING SALE — BUY 1 GET 1 FREE</span>
            </div>
            <div className="flex items-center gap-2 text-white font-semibold">
              <span className="text-xl">✦</span>
            ...
            <div className="flex items-center gap-2 text-white font-semibold">
              <span className="text-xl">✦</span>
              <span className="uppercase tracking-wider">WHILE SUPPLIES LAST</span>
            </div>
            <div className="flex items-center gap-2 text-white font-semibold">
              <span className="text-xl">✦</span>
              <span className="uppercase tracking-wider">EARLY SPRING SALE — BUY 1 GET 1 FREE</span>
      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-[#666666] max-w-3xl mx-auto">
            Two complete harvest systems. Two sets of bonus guides. Both backed by a lifetime warranty. Our early spring gift to you.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-[#1A1814]">
              The Grange Carrier™ – Buy 1, Get 1 Free
            </h3>

            {/* Capacity Info */}
            <p className="text-[#C86F4C] font-semibold">
              Early Spring Sale — Two carriers for the price of one. While supplies last.
            </p>
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2 text-sm text-[#4A3F35]">
                ...
                <span>2x The Grange Carrier™ with Zero-Gravity Cross-Back Harness</span>
              </div>
              <div className="flex items-start gap-2 text-sm text-[#4A3F35]">
                <span className="text-[#C86F4C] font-bold">+</span>
                <span>2x Quick-Release Drop-Chute toggle system</span>
              </div>
              <div className="flex items-start gap-2 text-sm text-[#4A3F35]">
                <span className="text-[#C86F4C] font-bold">+</span>
                <span>2x Deep utility sheaths for pruning tools</span>
              </div>
              <div className="flex items-start gap-2 text-sm text-[#4A3F35]">
                <span className="text-[#C86F4C] font-bold">+</span>
                <span>2x Hidden waterproof Vault pocket</span>
              </div>
              <div className="flex items-start gap-2 text-sm text-[#4A3F35]">
                <span className="text-[#C86F4C] font-bold">+</span>
            ...
            <div className="space-y-2">
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-xl text-[#999] line-through">$160</span>
                <span className="bg-[#4A3F35] text-white text-xs font-bold px-2 py-1 rounded">
                  BOGO FREE
                </span>
              </div>
              <p className="text-sm text-[#666666]">Two carriers for the price of one. Give one, keep one — or gift them both. This spring only.</p>
            </div>

            {/* Discount Auto-Applied Badge */}
            <div className="bg-yellow-100 text-[#666666] text-xs font-medium px-3 py-2 rounded text-center">
              ✓ BOGO automatically applied at checkout
            </div>
            ...
            <div className="space-y-2 pt-2">
              <div className="flex items-center gap-2 text-sm text-[#666666]">
                <CheckCircle2 className="h-4 w-4 text-[#C86F4C]" />
                <span>60-day money-back guarantee on both carriers</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-[#666666]">
                <CheckCircle2 className="h-4 w-4 text-[#C86F4C]" />
              ...
              <div className="flex items-center gap-2 text-sm text-[#666666]">
                <CheckCircle2 className="h-4 w-4 text-[#C86F4C]" />
                <span>1-day processing. Both arrive gift-ready.</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <CarouselContent className="-ml-4">
                  ...
                  <CarouselItem className="pl-4 basis-[85%]">
                    <div className="bg-[#4A3F35] rounded-2xl p-6 text-center h-full">
                      ...
                      <h3 className="text-lg font-bold text-white mb-2">2x The Grange Carrier™</h3>
                      <p className="text-sm text-white/70">Two thorn-proof canvas carriers with Zero-Gravity harness, Drop-Chute system, and 20-pound capacity pouch.</p>
                    </div>
                  </CarouselItem>
                  ...
                  <CarouselItem className="pl-4 basis-[85%]">
                    <div className="bg-[#4A3F35] rounded-2xl p-6 text-center h-full">
                      ...
                      <p className="text-sm text-white/70">Canvas, stitching, and buckles guaranteed against defects on both carriers. You&apos;re giving gifts that are covered for life.</p>
                    </div>
                  </CarouselItem>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-base md:text-lg text-[#666666]">
              Everything you need to know about the Early Spring BOGO gift offer
            </p>
          </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border border-[#D4C4B0] rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-[#1A1814] hover:text-[#C86F4C] py-5">
                How does Buy 1, Get 1 Free work as a gift?
              </AccordionTrigger>
              <AccordionContent className="text-[#666666] pb-5">
                You get two Grange Carriers for the price of one. Give both as gifts, or keep one for yourself and gift the other. Both come with the full lifetime warranty, 60-day guarantee, and two free gardening guides. It&apos;s our early spring celebration — the best time to stock up.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3" className="border border-[#D4C4B0] rounded-lg px-6">
              ...
              <AccordionContent className="text-[#666666] pb-5">
                This BOGO offer runs while supplies last. Once our early spring inventory is spoken for, the offer ends and pricing returns to normal. If you&apos;re planning a gift, now is the time.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5" className="border border-[#D4C4B0] rounded-lg px-6">
              ...
              <AccordionContent className="text-[#666666] pb-5">
                We process all orders within 1 business day. Standard shipping is 3-5 business days. Both carriers ship together in one package.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6" className="border border-[#D4C4B0] rounded-lg px-6">
              ...
              <AccordionContent className="text-[#666666] pb-5">
                Two Grange Carriers, each with Zero-Gravity harness and Drop-Chute system, The Endless Harvest gardening guide ($18 value), and the Harvest Keeper&apos;s Handbook ($15 value). Both backed by a lifetime warranty.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          ...
          <div className="text-center mt-12">
            <p className="text-[#666666] mb-4">Ready to give two gifts for the price of one?</p>
            <a href={PDP_URL}>
              <Button
                size="lg"
                className="bg-[#C86F4C] hover:bg-[#B5603F] text-white px-10 py-7 text-lg rounded font-semibold group"
