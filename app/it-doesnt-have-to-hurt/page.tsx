    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="max-w-2xl mx-auto px-4 pb-16">
        ...
        <div className="space-y-5 text-[17px] md:text-lg leading-[1.8] text-foreground/85">
          ...
          {/* Opening recognition — the accepted cycle */}
          <p>
            You weed eat the yard on a Saturday. By that evening your lower back aches. By Sunday it has stiffened up. By midweek it has loosened off &mdash; and by the next weekend you head out and do it all over again.
          </p>

          <p>
            Somewhere along the way you stopped treating that as a problem. The sore back just became part of the job. The price of a clean yard. Something that comes with owning a trimmer, like gas and string.
          </p>

          <p>
            Almost nobody questions it. You assume the pain is in the work itself &mdash; that weed eating, by its nature, is just hard on a back.
          </p>

          {/* The flip */}
          <p>
            It is not. And it does not matter whether you are 45 or 70 &mdash; the cause is the same, and it is not your age and it is not the work.
          </p>
          ...
          <p>
            The grip on every standard string trimmer in America is sized for an average man to hold down at his hip while he leans forward to see the cut line. That lean is what happens to your spine for 20, 30, 40 minutes every week.
          </p>

          <p>
            A 30 degree forward bend at the lumbar your body was never built to repeat. Do it long enough and your back stops absorbing it cleanly &mdash; and that is the evening it aches, and the Sunday it stiffens, every single time.
          </p>

          <p>
            The pain that follows is not weed eating taking its toll. It is your spine telling you it is being asked to do something it was never built to do, every Saturday, for as long as you have owned the trimmer.
          </p>
