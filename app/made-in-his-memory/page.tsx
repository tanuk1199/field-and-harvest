...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-5 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground leading-tight text-balance tracking-tight">
            6 Reasons a <span className="text-[#C86F4C]">72-Year-Old Widow</span> Designed This Carrier After Her Husband Passed
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mt-4 leading-relaxed text-pretty max-w-md mx-auto">
            He got her into gardening when they were newlyweds. Fifty years later, she&apos;s still out there every morning &mdash; and she built this apron so every harvest still feels like something they do together.
          </p>
        </div>
      ...
      {/* ============================================
          STORY INTRO - Short origin paragraph
          ============================================ */}
      <section className="max-w-lg mx-auto px-4 pb-4">
        <div className="bg-[#F4EFE3] border-l-4 border-[#C86F4C] rounded-r-lg p-6">
          <p className="text-foreground/85 text-pretty leading-relaxed text-base italic">
            &ldquo;Harold was the gardener when we married in 1974. He put a trowel in my hand on our second weekend and I never put it down. When he passed, I couldn&apos;t bear the thought of the beds going quiet. But after fifty years, my back, neck, and hands were done with the old baskets and aprons. So I sketched out the carrier Harold always said I needed. Six things had to be right. This is what I made.&rdquo;
          </p>
          <p className="text-sm font-bold text-foreground mt-4">&mdash; Eleanor, 72</p>
        </div>
      </section>
      ...
      <section className="max-w-lg mx-auto px-4 py-12 space-y-10">
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance leading-tight">
            Empty the whole harvest without bending over the sink
          </h3>
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Eleanor&apos;s arthritis made scooping produce out of a basket the worst part of the day. So she put a Quick-Release Drop-Chute on the bottom, held by industrial buckles that unlatch with a pinch. Her entire harvest now slides into the colander in one motion. <span className="font-bold text-foreground">She says it&apos;s the first thing she&apos;d never let a gardener live without.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            &ldquo;Stop hanging everything from your neck, El,&rdquo; he&apos;d say every summer. Every loop-style apron dangles the full load from one strap. An hour in and she&apos;d be sore by dinner. Her Zero-Gravity Cross-Back Harness spreads the weight across both shoulders and the upper back, like a proper hiking pack. <span className="font-bold text-foreground">Twenty pounds of tomatoes and you forget you&apos;re wearing it.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance leading-tight">
            The same canvas the pros trust on mountain expeditions
          </h3>
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Harold used to say &ldquo;buy once, cry once.&rdquo; Eleanor took that seriously. She specified Field-Weave 600D Canvas, the same fabric in premium ultralight backpacks. Thorn-proof, puncture-resistant, and light enough to forget. <span className="font-bold text-foreground">She wanted the carrier she made to outlast her &mdash; and be passed down to her grandkids.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance leading-tight">
            Hands free, twenty pounds, and no more trips back to the porch
          </h3>
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Eleanor used to do three and four trips a morning, bucket in one hand, shears in the other. She gave the carrier a kangaroo-style pouch that holds a full 20 pounds without collapsing, tool sheaths for her pruners, and a zippered pocket for her phone and reading glasses. <span className="font-bold text-foreground">Everything in one trip. Hands free the whole time.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Eleanor had ruined too many blouses on dewy mornings. Tomato juice. Wet soil. All of it soaks straight through cotton aprons. She lined the pouch with a Dry-Wear barrier that stops moisture cold. <span className="font-bold text-foreground">Now she goes straight from the beds to the kitchen to lunch with the grandkids &mdash; same clothes, no mess.</span>
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance leading-tight">
            Lifetime warranty. 60-day trial. Return shipping on us.
          </h3>
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Eleanor insisted on a lifetime warranty. If the fabric, stitching, or buckles ever fail, we replace it. Still on the fence? Try it for 60 days in your own garden. Full refund, we pay return shipping, no questions. <span className="font-bold text-foreground">She made it to be the last carrier you ever buy. We stand behind that.</span>
          </p>
        </div>
      </section>
      ...
      <section className="max-w-lg mx-auto px-4 pt-12 pb-4">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-6 text-pretty leading-relaxed max-w-md mx-auto">
            One carrier. Two free guides. A lifetime warranty. Designed by a gardener who knew exactly what she needed &mdash; and why.
          </p>
