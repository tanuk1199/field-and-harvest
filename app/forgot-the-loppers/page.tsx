              ...
              <div className="bg-[#F4EFE3] rounded-2xl border border-[#D4C4B0] p-4 md:p-5">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative flex-1 aspect-[3/4] rounded-md overflow-hidden bg-white shadow-md ring-1 ring-[#D4C4B0]">
                    <FtlAsset name="ebookEndlessHarvest" alt="The Endless Harvest gardening guide cover" className="absolute inset-0 w-full h-full object-cover" fallbackClassName="absolute inset-0 w-full h-full flex items-center justify-center text-2xl" />
                  </div>
                  ...
                  <div className="relative flex-1 aspect-[3/4] rounded-md overflow-hidden bg-white shadow-md ring-1 ring-[#D4C4B0]">
                    <FtlAsset name="ebookHarvestKeepers" alt="Harvest Keeper's Handbook cover" className="absolute inset-0 w-full h-full object-cover" fallbackClassName="absolute inset-0 w-full h-full flex items-center justify-center text-2xl" />
                  </div>
                </div>
      ...
      <section className="max-w-lg mx-auto px-4 pt-8 pb-32">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          <AccordionItem value="q-offer" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              You get up to 46% off the Grange Carrier (39% off a single, 44% off the 2-pack, 46% off the 3-pack) plus two free gardening guides — The Endless Harvest ($18 value) and the Harvest Keeper&apos;s Handbook ($15 value). Total $33 in free guides, automatically added at checkout.
            </AccordionContent>
          </AccordionItem>
