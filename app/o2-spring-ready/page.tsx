...
export default function O2SpringReadyPage() {
  return (
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mt-4 leading-relaxed text-pretty max-w-md mx-auto">
            Spring is weeks away. The gardeners who hit the ground running didn&apos;t wait until the first warm day to figure out their gear. This season, we&apos;re celebrating early with our biggest offer yet — buy one Grange Carrier, get a second one free.
          </p>
        </div>
      ...
      <section className="max-w-lg mx-auto px-4 py-12 space-y-10">
        ...
        <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-foreground mb-6 text-balance leading-tight">
            Every spring we sell out. This BOGO won&apos;t last long.
          </h3>
          ...
          <p className="text-foreground/80 text-pretty leading-relaxed text-base">
            Same pattern every year. Orders spike in March. Shipping times stretch into April. Last spring we went through our full stock twice before May. Right now, inventory is full, shipping is fast, and your carrier will be broken in and ready before the first seed hits the ground. <span className="font-bold text-foreground">This early spring BOGO is our way of kicking off the season — but once stock moves, the offer ends. 22,000 gardeners already own one. The ones who ordered early never had to think about it twice.</span>
          </p>
        </div>
      ...
      <section className="max-w-lg mx-auto px-4 pt-12 pb-4">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance leading-tight">
            Buy One, Get One Free. Spring Is Coming.
          </h2>
          <p className="text-lg text-muted-foreground mb-6 text-pretty leading-relaxed max-w-md mx-auto">
            Two carriers. Two free guides. A lifetime warranty on both. Get set up now — grab one for yourself and one for a fellow gardener.
          </p>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="item-1" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              Add the BOGO offer to your cart and you&apos;ll receive two Grange Carriers for the price of one. Both come with the full lifetime warranty, 60-day guarantee, and two free gardening guides. It&apos;s our early spring celebration — keep both or share one with a fellow gardener.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            ...
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              Orders are processed within 2 business days. Standard shipping is 7-9 business days. Order now and you&apos;ll have both carriers in your hands well before planting season kicks off.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-4" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            <AccordionTrigger className="text-left font-bold text-foreground hover:no-underline py-5">
              Will both carriers last through the whole season?
            </AccordionTrigger>
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              They&apos;ll last through decades of seasons. Field-Weave 600D Canvas is thorn-proof and holds its shape under a full 20-pound load. Both carriers are backed by a lifetime warranty against defects in materials and craftsmanship.
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="item-5" className="bg-card border-2 border-border rounded-lg px-6 shadow-sm">
            <AccordionTrigger className="text-left font-bold text-foreground hover:no-underline py-5">
              Why are you offering Buy 1 Get 1 Free?
            </AccordionTrigger>
            <AccordionContent className="text-foreground/80 leading-relaxed pb-5">
              It&apos;s our way of celebrating the start of a new growing season. We want to get as many gardeners set up before spring hits. Grab one for yourself and one for a partner, neighbor, or family member who gardens — or keep a spare at the potting bench.
            </AccordionContent>
          </AccordionItem>
