...
const STANDFIRST = "When the clocks go back, the back half of your property disappears until March. Most people fix the worst corner first and then start noticing the next one. Here is what makes this particular light worth putting on the drive, the side gate and the shed rather than just the one spot that finally annoyed you."     // 40-70 words at solution/product aware, 80-150 at problem aware
...
const REASONS: { n: number; title: string; media: Media; body: string[] }[] = [
  ...
  { n: 3, title: "So you can put it where no cable reaches", media: { kind: "image", src: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/nwl-11-shed-no-power_e9542a92-0a29-4dc3-b216-37744fd125a8.png?width=900", alt: "A solar security light on a garden shed with no mains power, lighting the door and a woodpile" }, body: ["The shed at the bottom of the yard. The fence line. The back gate, the kennel, the detached garage. These are the places people give up on, not because they do not need light but because getting power out there means a trench, an electrician, or a lead across the grass all winter.", "None of that applies here. The only question left is which wall catches the midday sun, and that is a two minute decision you make once."] },
  { n: 4, title: "Three heads aim where you point them, not where the bracket does", media: { kind: "image", src: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/nwl-06-coverage-diagram_cef0a8d8-38b7-4670-a7c7-659037449c9f.png?width=900", alt: "Overhead view of a house at night showing 270 degrees of light coverage from one fixture" }, body: ["The place you want lit is not a spot, it is a shape. A drive runs long. A yard runs wide. A corner is two walls meeting. Almost every outdoor light points one way because its bracket only lets it point one way, so you end up buying a second one for the other direction.", "These three heads pivot separately. One down the path, one across the approach, one back along the wall: 270 degrees of cover and 26 feet of motion range from a single mounting point."] },
  { n: 5, title: "One bracket, no wiring, no electrician", media: { kind: "image", src: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/nwl-13-install-height_24335ee8-a5e9-4817-91da-d8cd9068904f.png?width=900", alt: "A man mounting the solar security light to a house wall with a cordless screwdriver" }, body: ["There is nothing to switch off at the breaker first, because there is nothing to connect. Four screws and four wall anchors are in the box with the bracket and the remote.", "Hold it up, mark it, drive the screws, angle the heads. Six and a half to eight feet is the height the sensor was tuned for, and that is the whole installation."] },
