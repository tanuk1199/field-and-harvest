...
const REASONS: { n: number; title: string; media: Media; body: string[] }[] = [
  ...
  { n: 3, title: "Four screws, and it goes where no cable reaches", media: { kind: "image", src: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/nwl-11-shed-no-power_e9542a92-0a29-4dc3-b216-37744fd125a8.png?width=900", alt: "A solar security light on a garden shed with no mains power, lighting the door and a woodpile" }, body: ["The shed at the bottom of the yard. The fence line. The back gate, the kennel, the detached garage. People give up on those places because getting power out there means a trench, an electrician, or a lead across the grass all winter.", "None of that applies. Four screws and four wall anchors are in the box with the bracket and the remote, nothing gets switched off at the breaker, and the only question left is which wall catches the midday sun."] },
