...
const PDP_URL = "https://fieldandharvestco.com/products/the-yeoman-handle-1"
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-base text-muted-foreground/80 mt-3 max-w-md mx-auto">
            Comes as a set &mdash; one for each trimmer, or one to gift.
          </p>
        </div>
