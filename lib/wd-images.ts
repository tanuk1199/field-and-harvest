// ============================================================
// IMAGE ASSET MAP — Grange Carrier: Wedding Registry Listicle
// ============================================================
// Upload images to Shopify Files then paste the URL between the quotes.
// Empty string ("") = emoji fallback shown on page.
//
// ⚠️ Keys most likely to be swapped for the wedding-registry angle:
//   - heroImage     (warm editorial — couple in garden, or carrier in a styled
//                    mudroom/kitchen that reads "we kept it out, not in the closet")
//   - reason2Image  (two carriers side by side, or two people in a garden)
//   - reason3Image  (worn-in canvas / patina shot — the heirloom proof)
//
// All other keys default to the existing Grange Carrier assets.
// ============================================================

export const wdImages = {

  // ── NAVIGATION ──────────────────────────────────────────
  logo: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/Copy_of_COMFORT_CRADLE_Logos_5.png?v=1765838330",

  // ── HERO SECTION ──────────────────────────────────────────
  // ⚠️ Swap candidate — upload a warm couple-in-garden or styled mudroom shot.
  ...
  reason2Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1633_Image_Generation_remix_01kgdhykz1e4pb8gg9pyx1231h.png?v=1769981766",   // Harness — ⚠️ swap candidate (couple shot)
  reason3Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1633_Image_Generation_remix_01kgdhzb5nf1g8wz6q6eymvv6m.png?v=1769981770",   // Canvas — ⚠️ swap candidate (patina/heirloom)
  ...
  reason5Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1641_Image_Generation_remix_01kgdjcqnee5d9w8721g22c54a.png?v=1769982157",   // Wipes-clean
...
type WdImageKey = keyof typeof wdImages

export function getWdImage(key: WdImageKey): string | null {
  return wdImages[key] || null
}

export function getWdFallback(key: WdImageKey): string {
  return wdFallbacks[key]
}
