// ============================================================
// IMAGE ASSET MAP — Grange Carrier: Memorial Day Listicle
// ============================================================
// Upload images to Shopify Files then paste the URL between the quotes.
// Empty string ("") = emoji fallback shown on page.
//
// ⚠️ Keys most likely to be swapped for the planting-season angle:
//   - heroImage     (gardener mid-planting with seedlings — wet soil / spring greens)
//   - reason1Image  (drop-chute action shot — emptying soil/seedlings, not harvest)
//   - reason4Image  (carrier loaded with seedling six-packs + trowel + markers)
//
...
export const mdImages = {
  ...
  // ── HERO SECTION ──────────────────────────────────────────
  // ⚠️ Swap candidate — upload a planting-day hero (seedlings, fresh soil, spring light).
  ...
  reason1Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20251215_0105_Quick-ReleaseBadgeDesign_remix_01kcg9qjyre8psjsmn24ardmhq.png?v=1766034098",   // Drop-Chute — ⚠️ swap candidate (planting context)
  reason2Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1633_Image_Generation_remix_01kgdhykz1e4pb8gg9pyx1231h.png?v=1769981766",   // Zero-Gravity harness
  reason3Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1633_Image_Generation_remix_01kgdhzb5nf1g8wz6q6eymvv6m.png?v=1769981770",   // Field-Weave canvas
  reason4Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/Grange_hero_image_1_6.png?v=1769981762",                                              // Capacity — ⚠️ swap candidate (seedlings + tools)
  reason5Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1641_Image_Generation_remix_01kgdjcqnee5d9w8721g22c54a.png?v=1769982157",   // Wet-soil / dew protection
  reason6Image: "https://cdn.shopify.com/s/files/1/0651/8299/0379/files/20260201_1643_Image_Generation_remix_01kgdjgd8deat9ykzt5zkedtsn.png?v=1769982391",   // Lifetime warranty
...
type MdImageKey = keyof typeof mdImages

export function getMdImage(key: MdImageKey): string | null {
  return mdImages[key] || null
}

export function getMdFallback(key: MdImageKey): string {
  return mdFallbacks[key]
}
