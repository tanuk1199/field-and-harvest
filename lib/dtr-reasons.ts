...
export const reasons: ReasonData[] = [
  {
    ...
    image: 'https://cdn.shopify.com/s/files/1/0651/8299/0379/files/ysp-tile-sweetgum.png?v=1789354980',
    imageAlt: 'Spiky sweetgum seed balls and magnolia pods scattered across green grass',
