...
export const reasons: ReasonData[] = [
  ...
  },
  {
    ...
    paragraphs: ['Nothing on it is powered. **The wheels turn the brushes, and they turn them fast: one turn of the wheels spins the brushes five times.** So you walk at a normal pace and the brushes are moving quick enough to flick debris up off the grass. **It weighs 29.77 lb and you supply the power. If pushing a mower is already too much, this will be too.**'],
    ...
    bullets: ['No gas, no cords, no battery, nothing to service', 'Metal frame, and the core arrives assembled'],
  },
  {
    number: 3,
    ...
    bullets: ['No pile to bag afterwards', 'Nothing to start, refuel or charge', 'Quiet enough that the neighbors do not know'],
  },
  {
    number: 4,
  ...
  {
    number: 5,
    title: 'You set the brush height to match what is actually on the ground',
    titleAccent: 'Ten positions on a lever, no tool',
    image: 'https://cdn.shopify.com/s/files/1/0651/8299/0379/files/ysp-deck-height-poster.png?v=1789427760',
    imageAlt: 'A hand moving the orange height lever on the side of the sweeper deck through its notched positions',
    paragraphs: ['Acorns and gum balls sit down in the grass, so the brushes have to come down to meet them. Fine clippings on a thick lawn want them higher, where they flick instead of drag. **The lever on the side of the deck moves the brushes through ten positions, and you work it by hand with no tool to go and find.** Height is also what decides how hard it is to push. Too low and the brushes fight the ground the whole way. Set right and they roll.'],
    video: 'https://cdn.shopify.com/videos/c/vp/c6004505a087401ca2c3b1c22c01c106/c6004505a087401ca2c3b1c22c01c106.HD-1080p-2.5Mbps-94399442.mp4',
    poster: 'https://cdn.shopify.com/s/files/1/0651/8299/0379/files/ysp-deck-height-poster.png?v=1789427760',
    bullets: ['Ten brush heights, set from the side by hand', 'Low for acorns and gum balls, higher for thick or uneven grass', 'No tool to find and nothing to unbolt'],
  },
  {
    number: 6,
