export function EmailSignup() {
  return (
    <section className="mx-auto max-w-3xl px-4 py-14 text-center">
      ...
      <p className="mt-3 text-muted-foreground">Get the label guide we send out, so you can read any turmeric bottle in about a minute.</p>

      <form
        className="mx-auto mt-6 flex max-w-lg flex-col gap-3 sm:flex-row"
        action="https://fieldandharvestco.com/products/turmeric-curcumin-complex"
        method="get"
      >
