...
import { CtaButton } from '@/components/listicle-dtr/cta-button'
...
const ingredients: Ingredient[] = [
  ...
  {
    icon: Sprout,
    name: 'Acorns and gum balls',
    sub: 'Under the trees',
    does: 'Hard, round, and they roll away from a rake instead of gathering.',
    evidence: 'Mulching does nothing to them at all. They are still there in spring.',
  },
  {
    icon: Sparkles,
    name: 'Clippings in rows',
    sub: 'Where you mowed',
    does: 'The windrow the deck threw out on your last pass.',
    evidence: 'Rake it and you are bending forty times to move it twenty feet.',
  },
  {
    icon: Coffee,
    ...
    <section className="border-y-2 border-primary bg-accent text-accent-foreground">
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-16">
              ...
              >
                ...
                <div className="mt-1.5 sm:mt-0 sm:px-4 sm:py-6">
                  ...
                  <p className="mt-1 text-[12px] leading-snug text-muted-foreground sm:mt-2 sm:text-xs">
                    <span className="font-semibold uppercase tracking-wide">Why it is still there:</span>{' '}
                    {item.evidence}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-7 flex justify-center">
          <CtaButton
            label="See The Tool That Lifts It"
